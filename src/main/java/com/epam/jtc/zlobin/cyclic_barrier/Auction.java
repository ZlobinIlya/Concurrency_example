package com.epam.jtc.zlobin.cyclic_barrier;
...
public class Auction {
    ...
    public Auction() {
        ...
        this.barrier = new CyclicBarrier(this.BIDS_NUMBER, new Runnable() {
            public void run() {  //ТУТ МЫ ПЕРЕОПРЕДЕЛЯЕМ RUN для new Runnable!!!!!!!!!!!!!!!!!!!!!!
    ...
    public Bid defineWinner() {
        return Collections.max(bids, new Comparator<Bid>() {@Override  public int compare(Bid ob1, Bid ob2) {
